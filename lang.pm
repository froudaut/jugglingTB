...
{   
	...
	our $MSG_SSWAP_MENU_JDEEP_1 = "G\x{e9}n\x{e9}ration de Siteswaps Premiers (jdeep de Jack Boyce).";
...
"; 
	...
	################################################"
	#
	# CAUSAL Module Messages 
	#
	################################################"

	our $MSG_CAUSAL_MENU_HELP = "Diagrammes de Cause.\n"; 
	
	our $MSG_CAUSAL_MENU_CAUSALEDITOR_1 = "Causal Diagram Editor de The Juggling Edge.";
	our $MSG_CAUSAL_MENU_CAUSALEDITOR_2 = "Param\x{e8}tres :\n\n\- Aucun.";
	...
	our $MSG_HSS_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"oss\"> : OSS \x{e0} dessiner.\n\n\- <\"hss\"> : HSS \x{e0} dessiner.\n\n\- <\"fichier\"> : fichier image de r\x{e9}sultats.\n\n".$MSG_GRAPHVIZ_OPTS_a4.$MSG_GRAPHVIZ_OPTS_b4."\n\n\n\- [\\%hash] : Optionnel, hash des transitions pour OSS. Dans ce cas le Siteswap n'est utilis\x{e9} que pour le titre. Chaque Cl\x{e9}/Valeur est de la forme : Ri:j pour une transition amorc\x{e9}e \x{e0} droite ou Li:j lorsqu'il s'agit de la gauche. i correspond au Beat du lancer et j est le num\x{e9}ro de l'objet lors du lancer (en commen\x{e7}ant \x{e0} 0) pour aider \x{e0} la colorisation. \n\tEx :  %hash = (
	\t'L2:0' => 'R4:0',
	\t'R2:0' => 'R4:1',
	\t'L4:0' => 'R6:0',
	\t'R4:0' => 'R5:0',
	...
	our $MSG_HSS_ISVALID_ERROR5 = "Z\x{e9}ro dans HSS doit correspondre \x{e0} Z\x{e9}ro dans OSS.";
	...
	our $MSG_MHN_MENU_TOMJN_1 = "Donne la Notation MJN correspondante.";
	our $MSG_MHN_MENU_TOMJN_2 = "Param\x{e8}tres :\n\n\- <\"mhn\"> : MHN.\n\- [int] Optionnel, Mod\x{e8}le MJN (0: auto, 1: async, 2: sync) (D\x{e9}faut:0).\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher."; 

	our $MSG_MHN_MENU_GENPOLYRHYTHM_1 = "G\x{e9}n\x{e9}ration de Polyrythmes.";
	our $MSG_MHN_MENU_GENPOLYRHYTHM_2 = "Param\x{e8}tres :\n\n\- <int> : Nombre de mains.\n\- <int> : Nombre d'objets.\n\- <int> : Hauteur Max en h\x{e9}xa.\n\- <\"List\"> : List de Ratios depuis la Main 1, s\x{e9}par\x{e9}s par , [ex: 1:2,1:3].\n\- [\\\@List] Optionnel, Lancers \x{e0} exclure.\n\tEx: \@List=('0','2','1x').\n\t Si non pr\x{e9}cis\x{e9}, sans autre param\x{e8}tre optionnel, 0 est exclu;\n\t si \'\', pas d'exclusion.\n\- [\"options\"] Diff\x{e9}rentes Options parmi \-[b|f|j|l|m|q]\n\t\-b <y|n> : Affichage du MJN (D\x{e9}faut:n).\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\t\-j <y|n> : Ajoute MHNs transform\x{e9}s pour des lancers plus bas mais en conservant le Tempo des lancers par le biais de Hold Times suppl\x{e9}mentaires et adapt\x{e9} pour une visualisation JugglingLab. JugglingLab ne comprenant que des Hold Times sur des lancers 1x ou 2, les Hold Times de valeur sup\x{e9}rieure seront donc convertis (D\x{e9}faut:n).\n\t\-l <y|n> : Ajoute MHNs transform\x{e9}s pour des lancers plus bas mais en conservant le Tempo des lancers par le biais de Hold Times suppl\x{e9}mentaires (D\x{e9}faut:n).\n\t\-m <y|n> : Affichage du MJN et du MHN (D\x{e9}faut:y).\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\- [\"fichier\"] Optionnel, fichier de r\x{e9}sultats.\nSi le fichier commence par : \n\t\- \'JML:\', g\x{e9}n\x{e8}re un fichier pour une vue JugglingLab \n\t\ten JML en y ajoutant l'extension .jml.\n\t\- \'HTML:\', g\x{e9}n\x{e8}re un fichier HTML, en y ajoutant l'extension \n\t\t.html et contenant les Diagrammes, les versions MJNs, les r\x{e9}sum\x{e9}s JML/TXT.";

	our $MSG_MHN_MENU_LOWERHEIGHTONTEMPO_1 = "Transformation de MHNs pour des lanc\x{e9}s plus bas en conservant le Tempo des lanc\x{e9}s mais en ajoutant des temps suppl\x{e9}mentaires de Hold Times.";
	our $MSG_MHN_MENU_LOWERHEIGHTONTEMPO_2 = "Particuli\x{e8}rement int\x{e9}ressant pour les Polyrythmes.\n\nParam\x{e8}tres :\n\n\- <\"mhn\"> : MHN \x{e0} transformer.\n\n\- [\"options\"] Diff\x{e9}rentes options \-[f|j|m] pr\x{e9}cis\x{e9}es ci-dessous:\n\t\-f <int> : Nombre de Free Beats Minimums sur la transformation entre 2 lancers (D\x{e9}faut:1). Comme l'objet est r\x{e9}cup\x{e9}r\x{e9} un peu avant son lancer, avec g\x{e9}n\x{e9}ralement un Dwell Time autour de 1, une valeur inf\x{e9}rieure occasionne des squeezes.\n\t\-j <y|n> : Adaptation JugglingLab. JugglingLab ne comprenant que des Hold Times sur des lancers 1x ou 2, les Hold Times de valeur sup\x{e9}rieure seront donc convertis.\n\t\-m <int> : Valeur Minimum du lanc\x{e9} sur m\x{ea}me main apr\x{e8}s transformation afin d'\x{e9}viter par exemple une transformation d'un lanc\x{e9} en hold (D\x{e9}faut:3).\n\n[\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher (D\x{e9}faut:n)";	
	
	our $MSG_MHN_MENU_PRINTMHNLISTHTML_1 = "Cr\x{e9}e un fichier HTML depuis une Liste de MHNs en ajoutant diagrammes, JML JugglingLab et listes TXT.";
	our $MSG_MHN_MENU_PRINTMHNLISTHTML_2 = "Param\x{e8}tres :\n\n\- <\\\@List> : Input Liste contenant les MHNs ou \-1 pour Liste Vide.\n\n\- <\"fichierOutput\"> : Fichiers r\x{e9}sultats (avec ajout extensions .html).\n\n\- <\"string\"> : Titre.\n\n\- [\"options\"] Diff\x{e9}rentes options \-[b|f|j|l|m|q] :\n\n\t\-b <y|n> : Affiche MHN et MJN (D\x{e9}fault:n).\n\t\-f <0|1|2> : Splines Mode pour affichage : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\t\-j <y|n> : Ajoute une colonne avec MHNs transform\x{e9}s pour des lancers plus bas mais en conservant le Tempo des lancers par le biais de Hold Times suppl\x{e9}mentaires et adapt\x{e9} pour une visualisation JugglingLab. JugglingLab ne comprenant que des Hold Times sur des lancers 1x ou 2, les Hold Times de valeur sup\x{e9}rieure seront donc convertis (D\x{e9}faut:n).\n\t\-l <y|n> : Ajoute une colonne avec MHNs transform\x{e9}s pour des lancers plus bas mais en conservant le Tempo des lancers par le biais de Hold Times suppl\x{e9}mentaires (D\x{e9}faut:n).\n\t\-m <y|n> : MJN uniquement. Option surcharg\x{e9}e par \-b (D\x{e9}faut:n).\n\t\-q <y|n> : Affichage rapide au d\x{e9}triment de la qualit\x{e9} (D\x{e9}fault:n).\n\n[\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.\n\- <\"inputFile\"> : Fichier contenant la liste de MHNs si la Liste input est vide.";       
	...
	our $MSG_MHN_POLYRHYTHM_MSG1 = "Ratio(s)";
	our $MSG_MHN_GENPOLYRYTHM_ERR0 = "Nombre de Ratios doit \x{ea}tre \x{e9}gal \x{e0} Nombre de Mains -1.";
	our $MSG_MHN_GENERAL2 = "Nombre d'Objets";
	our $MSG_MHN_GENERAL3 = "Nombre de Mains";
	...
	our $MSG_MJN_MENU_HELP = "Multi-Juggler Notation (MJN) telle qu'utilis\x{e9}e dans JugglingLab ou JoePass.\n\nLe format utilis\x{e9} est le suivant pour chaque Beat Asynchrone ou Synchrone :\n<Jongleur 1|Jongleur 2|...|Jongleur j> .\nEn mode Synchrone, le symbole ! est accept\x{e9}. On se reportera \x{e0} la documentation de JugglingLab au besoin\n\nVoici des exemples possibles : <2|3p><2p|3><[3p/2]|3p><3|3> ou encore <(2p3,4x)|(2xp3,4p1)|(2xp2,4xp2)>. \nIl est \x{e9}galement possible de faire un d\x{e9}coupage par jongleur : <22p3p/23|3p33p3>";
	
	our $MSG_MJN_MENU_ISVALID_1 = "Teste la validit\x{e9} du MJN.";
	our $MSG_MJN_MENU_ISVALID_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} tester\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.\n\- [\"List\"] en Asynchrone, liste des Mains initiales des jongleurs s\x{e9}par\x{e9}e par , dans le cas o\x{f9} on ne commence pas par la main droite [ex: R,L,L].";
	our $MSG_MJN_MENU_ISSYNTAXVALID_1 = "Teste la syntaxe grammaticale du MJN.";
	our $MSG_MJN_MENU_ISSYNTAXVALID_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} tester\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";
	our $MSG_MJN_MENU_ISASYNC_1 = "Teste le caract\x{e8}re Asynchrone du MJN.";
	our $MSG_MJN_MENU_ISASYNC_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} tester\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";
	our $MSG_MJN_MENU_GETPERIOD_1 = "Donne la P\x{e9}riode du MJN.";
	our $MSG_MJN_MENU_GETPERIOD_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} analyser.\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";
	our $MSG_MJN_MENU_GETOBJNUMBER_1 = "Donne le nombre d'objets du MJN.";
	our $MSG_MJN_MENU_GETOBJNUMBER_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} analyser.\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";
	our $MSG_MJN_MENU_GETJUGGLERSNUMBER_1 = "Donne le nombre de jongleurs du MJN.";
	our $MSG_MJN_MENU_GETJUGGLERSNUMBER_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} analyser.\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";
	our $MSG_MJN_MENU_DRAW_1 = "Dessine le Diagramme associ\x{e9} au MJN.";
	our $MSG_MJN_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} dessiner.\n\n\- <\"fichier\"> : fichier image de r\x{e9}sultats.\n\n".$MSG_GRAPHVIZ_OPTS_a6.$MSG_GRAPHVIZ_OPTS_b6."\n\n\- [\\%hash] : Optionnel, hash des transitions en Mode Asynchrone. Dans ce cas le Siteswap n'est utilis\x{e9} que pour le titre. Chaque Cl\x{e9}/Valeur est de la forme : Ri:j pour une transition amorc\x{e9}e \x{e0} droite ou Li:j lorsqu'il s'agit de la gauche. i correspond au Beat du lancer et j est le num\x{e9}ro de l'objet lors du lancer (en commen\x{e7}ant \x{e0} 0) pour aider \x{e0} la colorisation. \n\tEx :  %hash = (
	\t'L2:0' => 'R4:0',
	\t'R2:0' => 'R4:1',
	\t'L4:0' => 'R6:0',
	\t'R4:0' => 'R5:0',
	...
	our $MSG_MJN_MENU_TOMHN_1 = "Donne la Notation MHN correspondante.";
	our $MSG_MJN_MENU_TOMHN_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN.\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.\n\- [\"List\"] en Asynchrone, liste des Mains initiales des jongleurs s\x{e9}par\x{e9}e par , dans le cas o\x{f9} on ne commence pas par la main droite [ex: R,L,L]."; 
	
	our $MSG_MJN_ISVALID_ERR0 = "MJN Invalide"; 



	################################################"
	#
	# MJHSS Module Messages 
	#
	################################################"

	our $MSG_MJHSS_MENU_HELP = "Multi-Juggler Hand Siteswap Notation (MJHSS).\n\nL'id\x{e9}e est d'appliquer un HSS sur chaque colonne d'une matrice MJN en mod\x{e8}le Siteswap Asynchrone.  Le format utilis\x{e9} pour le MJHSS est : '('HSS1, ... HSSh')', chaque HSSi s'appliquant sur la colonne i et \x{e9}tant un Siteswap Vanille.";

	our $MSG_MJHSS_MENU_DRAW_1 = "Dessine le Diagramme associ\x{e9} au MJN/MJHSS.";
	our $MSG_MJHSS_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN \x{e0} dessiner. \n\n\- <\"mjhss\"> : MJHSS correspondant. \n\n\- <\"fichier\"> : fichier image de r\x{e9}sultats.\n\n".$MSG_GRAPHVIZ_OPTS_a7.$MSG_GRAPHVIZ_OPTS_b7;

	our $MSG_MJHSS_MENU_ISVALID_1 = "Teste la validit\x{e9} de la combinaison MJN/MJHSS.";
	our $MSG_MJHSS_MENU_ISVALID_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN\n\- <\"mjhss\"> : MJHSS\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";	

	our $MSG_MJHSS_DRAW_1 = "Warning : On doit retrouver le m\x{ea}me nombre de set de Mains dans la MJN et dans le MJHSS"; 		 

	our $MSG_MJHSS_ISVALID_ERR0 = "Erreur : Invalide MJN."; 
	our $MSG_MJHSS_ISVALID_ERR1 = "Erreur : On doit retrouver le m\x{ea}me nombre de set de Mains dans la MJN et dans le MJHSS."; 
	our $MSG_MJHSS_ISVALID_ERR2 = "Erreur : Invalide HSS"; 
	our $MSG_MJHSS_ISVALID_ERR3 = "Erreur : HSS doit \x{ea}tre un Siteswap Vanille."; 
	our $MSG_MJHSS_ISVALID_ERR4 = "Error : Z\x{e9}ro dans HSS doit correspondre \x{e0} Z\x{e9}ro dans MJN"; 
	our $MSG_MJHSS_ISVALID_ERR5 = "Erreur : MJN doit \x{ea}tre de mod\x{e8}le Asynchrone."; 


	################################################"
	#
	# MLHSS Module Messages 
	#
	################################################"

	our $MSG_MLHSS_MENU_HELP = "Multi-Layer Hand Siteswap Notation (MLHSS).\n\nL'id\x{e9}e est d'appliquer un HSS sur chaque ligne d'une matrice MHN. Chaque ligne MHN correspond donc \x{e0} plusieurs mains lan\x{e7}ant de mani\x{e8}re asynchrone. Le format utilis\x{e9} pour le MLHSS est : '('HSS1, ... HSSh')', chaque HSSi s'appliquant sur la ligne i et \x{e9}tant un Siteswap Vanille.";

	our $MSG_MLHSS_MENU_DRAW_1 = "Dessine le Diagramme associ\x{e9} au MHN/MLHSS.";
	our $MSG_MLHSS_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mhn\"> : MHN \x{e0} dessiner. \n\n\- <\"mlhss\"> : MLHSS correspondant. \n\n\- <\"fichier\"> : fichier image de r\x{e9}sultats.\n\n".$MSG_GRAPHVIZ_OPTS_a5.$MSG_GRAPHVIZ_OPTS_b5;

	our $MSG_MLHSS_MENU_ISVALID_1 = "Teste la validit\x{e9} de la combinaison MHN/MLHSS.";
	our $MSG_MLHSS_MENU_ISVALID_2 = "Param\x{e8}tres :\n\n\- <\"mhn\"> : MHN\n\- <\"mlhss\"> : MLHSS\n\- [\-1] Optionnel, retourne le r\x{e9}sultat sans l'afficher.";	

	our $MSG_MLHSS_DRAW_1 = "Warning : On doit retrouver le m\x{ea}me nombre de set de Mains dans la MHN et dans le MLHSS"; 		 

	our $MSG_MLHSS_ISVALID_ERR0 = "Erreur : Invalide MHN."; 
	our $MSG_MLHSS_ISVALID_ERR1 = "Erreur : On doit retrouver le m\x{ea}me nombre de set de Mains dans la MHN et dans le MLHSS."; 
	our $MSG_MLHSS_ISVALID_ERR2 = "Erreur : Invalide HSS"; 
	our $MSG_MLHSS_ISVALID_ERR3 = "Erreur : HSS doit \x{ea}tre un Siteswap Vanille."; 
	our $MSG_MLHSS_ISVALID_ERR4 = "Error : Z\x{e9}ro dans HSS doit correspondre \x{e0} Z\x{e9}ro dans MHN."; 
	...
	our $MSG_GRAPHVIZ_OPTS_a3 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|z] pr\x{e9}cis\x{e9}es ci-dessous :";
	our $MSG_GRAPHVIZ_OPTS_a4 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|g|h|i|l|m|n|o|p|q|s|t|v|y] pr\x{e9}cis\x{e9}es ci-dessous :";
	our $MSG_GRAPHVIZ_OPTS_a5 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|f|g|h|j|k|l|n|o|p|q|s|t|v|y] pr\x{e9}cis\x{e9}es ci-dessous :";
	our $MSG_GRAPHVIZ_OPTS_a6 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|u|v|w|z] pr\x{e9}cis\x{e9}es ci-dessous :";
	our $MSG_GRAPHVIZ_OPTS_a7 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|y|z] pr\x{e9}cis\x{e9}es ci-dessous :";
	...
	our $MSG_GRAPHVIZ_OPTS_b3 = "\n\n\t\-a <y|n> : Repr\x{e9}sentation Asynchrone (OSS/HSS) si possible (D\x{e9}faut:n)\n\n\t\-b <\"string\"> : base de nommage des mains (D\x{e9}faut:H).\n\n\t\-c <int> : Mode de colorisation en Asynchrone (D\x{e9}faut:2). Sinon la colorisation est calcul\x{e9}e selon le beat le plus petit et l'ordre des Mains. \n\t\t'0' : pas de colorisation;\n\t\t'1' : Multiplexe dans l'ordre croissant des valeurs \n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents;\n\t\t'2' : Multiplexe dans l'ordre d\x{e9}croissant des valeurs\n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents.\n\n\t\-d <int> :  Synchronous Hack (D\x{e9}faut:0)\n\t\t'0' : Suppression des 0 dans le diagramme apr\x{e8}s les lancers \n\t\tsynchrones puisqu'il s'agit des r\x{e9}ceptions;\n\t\t'1' : Pas de hack.\n\n\t\-e <\"string\"> : Couleur du Label de la fl\x{e8}che selon le codage X11 \n\tde Graphviz (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E pour couleur identique \x{e0} la fl\x{e8}che \n\t(D\x{e9}faut:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Conserve Fichier Graphviz pour g\x{e9}n\x{e9}ration (D\x{e9}faut:n).\n\n\t\-h <y|n> : Affichage des Mains (D\x{e9}faut:y).\n\n\t\-j <y|n> : Affichage des Mains sur chaque Beat, pour un Mod\x{e8}le MLHSS (D\x{e9}faut:n).\n\n\t\-k \"liste de listes avec ( ) et ,\" : Enum\x{e9}ration des Mains pour un mod\x{e8}le MLHSS. Ex (M1,M2)(M3,M4) \n\n\t\-l <pos> : Position du label de Siteswap\n\t\t't': tail, pr\x{e8}s de la queue de la fl\x{e8}che; \n\t\t'h': head, pr\x{e8}s de la t\x{ea}te; \n\t\t'm': middle, au centre de la fl\x{e8}che; \n\t\t'x': external, au centre de la fl\x{e8}che apr\x{e8}s trac\x{e9}; \n\t\t's': state, pr\x{e8}s de l'Etat; \n\t\t'n': Pas de label de Siteswap.\n\n\t\-m <0|1|2> : Mod\x{e8}le de diagramme (D\x{e9}faut: selon le type de Siteswap)\n\t\t'0' : Ladder;\n\t\t'1' : Applanissement de Ladder (Siteswap Asynchrone);\n\t\t'2' : Ladder avec suppression des Beats impairs en \n\t\tcommen\x{e7}ant \x{e0} 0 (Siteswap Synchrone).\n\n\t\-n <y|n> : Affichage des lancers n\x{e9}gatifs [Exp\x{e9}rimental] \n\t\t(D\x{e9}faut:n).\n\n\t\-o <type> : format d'image (D\x{e9}faut:png) parmi : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-p <int> : P\x{e9}riode minimum \x{e0} afficher (D\x{e9}faut:25).\n\n\t\-s <int> : Affichage du r\x{e9}sultat (D\x{e9}faut:0)\n\t\t'0' : Affiche le r\x{e9}sultat;\n\t\t'1' : Pas d'affichage.\n\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\t\-t <y|n> : Affichage du titre de l'image (D\x{e9}faut:y).\n\n\t\-v <\"string\"> : Force la valeur du Titre de l'image.\n\n\t\-z <\"y|n\"> : Z\x{e9}ro possible dans la repr\x{e9}sentation HSS ((D\x{e9}faut:y).";

	our $MSG_GRAPHVIZ_OPTS_b4 = "\n\n\t\-c <int> :  Mode de colorisation (D\x{e9}faut:2).\n\t\t'0' : pas de colorisation;\n\t\t'1' : Multiplexe dans l'ordre croissant des valeurs \n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents;\n\t\t'2' : Multiplexe dans l'ordre d\x{e9}croissant des valeurs\n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents.\n\n\t\-d <int> :  Synchronous Hack (D\x{e9}faut:0)\n\t\t'0' : Suppression des 0 dans le diagramme apr\x{e8}s les lancers \n\t\tsynchrones puisqu'il s'agit des r\x{e9}ceptions;\n\t\t'1' : Pas de hack.\n\n\t\-e <\"string\"> : Couleur du Label de la fl\x{e8}che selon le codage X11 \n\tde Graphviz (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E pour couleur identique \x{e0} la fl\x{e8}che \n\t(D\x{e9}faut:E).\n\n\t\-g <y|n> : Conserve Fichier Graphviz pour g\x{e9}n\x{e9}ration (D\x{e9}faut:n).\n\n\t\-h <y|n> : Affichage des Mains.\n\n\t\-i \"Liste avec ,\": Enumeration des mains pour les diagrammes Vanille.\n\n\t\-l <pos> : Position du label de Siteswap\n\t\t't': tail, pr\x{e8}s de la queue de la fl\x{e8}che; \n\t\t'h': head, pr\x{e8}s de la t\x{ea}te; \n\t\t'm': middle, au centre de la fl\x{e8}che; \n\t\t'x': external, au centre de la fl\x{e8}che apr\x{e8}s trac\x{e9}; \n\t\t's': state, pr\x{e8}s de l'Etat; \n\t\t'n': Pas de label de Siteswap.\n\n\t\-m <0|1|2> : Mod\x{e8}le de diagramme (D\x{e9}faut: selon le type de Siteswap)\n\t\t'0' : Ladder;\n\t\t'1' : Applanissement de Ladder (Siteswap Asynchrone);\n\t\t'2' : Ladder avec suppression des Beats impairs en \n\t\tcommen\x{e7}ant \x{e0} 0 (Siteswap Synchrone).\n\n\t\-n <y|n> : Affichage des lancers n\x{e9}gatifs [Exp\x{e9}rimental] \n\t\t(D\x{e9}faut:n).\n\n\t\-o <type> : format d'image (D\x{e9}faut:png) parmi : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-p <int> : P\x{e9}riode minimum \x{e0} afficher (D\x{e9}faut:25).\n\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\t\-s <int> : Affichage du r\x{e9}sultat (D\x{e9}faut:0)\n\t\t'0' : Affiche le r\x{e9}sultat;\n\t\t'1' : Pas d'affichage.\n\n\t\-t <y|n> : Affichage du titre de l'image (D\x{e9}faut:y).\n\n\t\-v <\"string\"> : Force la valeur du Titre de l'image";
	
	our $MSG_GRAPHVIZ_OPTS_b5 = "\n\n\t\-a <y|n> : Dessine HSS (D\x{e9}faut:y).\n\n\t\-b <\"string\"> : base de nommage des Layers MLHSS (D\x{e9}faut:J).\n\n\t\-c <int> : Mode de colorisation pour HSS (D\x{e9}faut:2). Sinon la colorisation est calcul\x{e9}e selon le beat le plus petit et l'ordre des Mains. \n\t\t'0' : pas de colorisation;\n\t\t'1' : Multiplexe dans l'ordre croissant des valeurs \n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents;\n\t\t'2' : Multiplexe dans l'ordre d\x{e9}croissant des valeurs\n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents.\n\n\t\-d <int> :  Synchronous Hack (D\x{e9}faut:0)\n\t\t'0' : Suppression des 0 dans le diagramme apr\x{e8}s les lancers \n\t\tsynchrones puisqu'il s'agit des r\x{e9}ceptions;\n\t\t'1' : Pas de hack.\n\n\t\-e <\"string\"> : Couleur du Label de la fl\x{e8}che selon le codage X11 \n\tde Graphviz (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E pour couleur identique \x{e0} la fl\x{e8}che \n\t(D\x{e9}faut:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Conserve Fichier Graphviz pour g\x{e9}n\x{e9}ration (D\x{e9}faut:n).\n\n\t\-h <y|n> : Affichage des Layers (D\x{e9}faut:y).\n\n\t\-j <y|n> : Affichage des Mains sur chaque Beat (D\x{e9}faut:y).\n\n\t\-k <\"string\"> : Base de nommage des Mains (D\x{e9}faut:H).\n\n\t\-l <pos> : Position du label de Siteswap\n\t\t't': tail, pr\x{e8}s de la queue de la fl\x{e8}che; \n\t\t'h': head, pr\x{e8}s de la t\x{ea}te; \n\t\t'm': middle, au centre de la fl\x{e8}che; \n\t\t'x': external, au centre de la fl\x{e8}che apr\x{e8}s trac\x{e9}; \n\t\t's': state, pr\x{e8}s de l'Etat; \n\t\t'n': Pas de label de Siteswap.\n\n\t\-n <y|n> : Affichage des lancers n\x{e9}gatifs [Exp\x{e9}rimental] \n\t\t(D\x{e9}faut:n).\n\n\t\-o <type> : format d'image (D\x{e9}faut:png) parmi : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-p <int> : P\x{e9}riode minimum \x{e0} afficher (D\x{e9}faut:25).\n\n\t\-s <int> : Affichage du r\x{e9}sultat (D\x{e9}faut:0)\n\t\t'0' : Affiche le r\x{e9}sultat;\n\t\t'1' : Pas d'affichage.\n\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\t\-t <y|n> : Affichage du titre de l'image (D\x{e9}faut:y).\n\n\t\-v <\"string\"> : Force la valeur du Titre de l'image.\n\n\t\-y <int> : Style HSS, 0: Dashed, 1: Dotted, 2 : Solid, 3: Bold, 4: Invis (D\x{e9}faut:0).";

	our $MSG_GRAPHVIZ_OPTS_b6 = "\n\n\t\-a <y|n> : Repr\x{e9}sentation Asynchrone (OSS/HSS) si possible (D\x{e9}faut:n)\n\n\t\-b <\"string\"> : base de nommage des jongleurs (D\x{e9}faut:J).\n\n\t\-c <int> : Mode de colorisation en Asynchrone (D\x{e9}faut:2). Sinon la colorisation est calcul\x{e9}e selon le beat le plus petit et l'ordre des Mains. \n\t\t'0' : pas de colorisation;\n\t\t'1' : Multiplexe dans l'ordre croissant des valeurs \n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents;\n\t\t'2' : Multiplexe dans l'ordre d\x{e9}croissant des valeurs\n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents.\n\n\t\-d <int> :  Synchronous Hack (D\x{e9}faut:0)\n\t\t'0' : Suppression des 0 dans le diagramme apr\x{e8}s les lancers \n\t\tsynchrones puisqu'il s'agit des r\x{e9}ceptions;\n\t\t'1' : Pas de hack.\n\n\t\-e <\"string\"> : Couleur du Label de la fl\x{e8}che selon le codage X11 \n\tde Graphviz (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E pour couleur identique \x{e0} la fl\x{e8}che \n\t(D\x{e9}faut:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Conserve Fichier Graphviz pour g\x{e9}n\x{e9}ration (D\x{e9}faut:n).\n\n\t\-h <y|n> : Affichage des Jongleurs (D\x{e9}faut:y).\n\n\t\-j <y|n> : Affichage des Mains sur chaque Beat, pour un Mod\x{e8}le MJHSS (D\x{e9}faut:n).\n\n\t\-k \"liste de listes avec ( ) et ,\" : Enum\x{e9}ration des Mains pour un mod\x{e8}le MJHSS. Ex (M1,M2)(M3,M4) \n\n\t\-l <pos> : Position du label de Siteswap\n\t\t't': tail, pr\x{e8}s de la queue de la fl\x{e8}che; \n\t\t'h': head, pr\x{e8}s de la t\x{ea}te; \n\t\t'm': middle, au centre de la fl\x{e8}che; \n\t\t'x': external, au centre de la fl\x{e8}che apr\x{e8}s trac\x{e9}; \n\t\t's': state, pr\x{e8}s de l'Etat; \n\t\t'n': Pas de label de Siteswap.\n\n\t\-m <0|1|2> : Mod\x{e8}le de diagramme (D\x{e9}faut: selon le type de Siteswap)\n\t\t'0' : Ladder;\n\t\t'1' : Applanissement de Ladder (Siteswap Asynchrone);\n\t\t'2' : Ladder avec suppression des Beats impairs en \n\t\tcommen\x{e7}ant \x{e0} 0 (Siteswap Synchrone).\n\n\t\-n <y|n> : Affichage des lancers n\x{e9}gatifs [Exp\x{e9}rimental] \n\t\t(D\x{e9}faut:n).\n\n\t\-o <type> : format d'image (D\x{e9}faut:png) parmi : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-p <int> : P\x{e9}riode minimum \x{e0} afficher (D\x{e9}faut:25).\n\n\t\-s <int> : Affichage du r\x{e9}sultat (D\x{e9}faut:0)\n\t\t'0' : Affiche le r\x{e9}sultat;\n\t\t'1' : Pas d'affichage.\n\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\t\-t <y|n> : Affichage du titre de l'image (D\x{e9}faut:y).\n\n\t\-u <\"List\"> en Asynchrone, liste des Mains initiales des jongleurs s\x{e9}par\x{e9}e par , dans le cas o\x{f9} on ne commence pas par la main droite [ex: R,L,L].\n\n\t\-v <\"string\"> : Force la valeur du Titre de l'image.\n\n\t\-w <y|n> : Force MHN Mod\x{e8}le (D\x{e9}faut:n).\n\n\t\-z <\"y|n\"> : Z\x{e9}ro possible dans la repr\x{e9}sentation HSS ((D\x{e9}faut:y).";

	our $MSG_GRAPHVIZ_OPTS_b7 = "\n\n\t\-a <y|n> : Dessine HSS (D\x{e9}faut:y).\n\n\t\-b <\"string\"> : base de nommage des jongleurs (D\x{e9}faut:J).\n\n\t\-c <int> : Mode de colorisation en Asynchrone (D\x{e9}faut:2). Sinon la colorisation est calcul\x{e9}e selon le beat le plus petit et l'ordre des Mains. \n\t\t'0' : pas de colorisation;\n\t\t'1' : Multiplexe dans l'ordre croissant des valeurs \n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents;\n\t\t'2' : Multiplexe dans l'ordre d\x{e9}croissant des valeurs\n\t\t Siteswap des lancers pr\x{e9}c\x{e9}dents.\n\n\t\-d <int> :  Synchronous Hack (D\x{e9}faut:0)\n\t\t'0' : Suppression des 0 dans le diagramme apr\x{e8}s les lancers \n\t\tsynchrones puisqu'il s'agit des r\x{e9}ceptions;\n\t\t'1' : Pas de hack.\n\n\t\-e <\"string\"> : Couleur du Label de la fl\x{e8}che selon le codage X11 \n\tde Graphviz (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E pour couleur identique \x{e0} la fl\x{e8}che \n\t(D\x{e9}faut:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Conserve Fichier Graphviz pour g\x{e9}n\x{e9}ration (D\x{e9}faut:n).\n\n\t\-h <y|n> : Affichage des Jongleurs (D\x{e9}faut:y).\n\n\t\-j <y|n> : Affichage des Mains sur chaque Beat, pour un Mod\x{e8}le MJHSS (D\x{e9}faut:n).\n\n\t\-k <\"string\"> : Base de nommage des Mains (D\x{e9}faut:H).\n\n\t\-l <pos> : Position du label de Siteswap\n\t\t't': tail, pr\x{e8}s de la queue de la fl\x{e8}che; \n\t\t'h': head, pr\x{e8}s de la t\x{ea}te; \n\t\t'm': middle, au centre de la fl\x{e8}che; \n\t\t'x': external, au centre de la fl\x{e8}che apr\x{e8}s trac\x{e9}; \n\t\t's': state, pr\x{e8}s de l'Etat; \n\t\t'n': Pas de label de Siteswap.\n\n\t\-m <0|1|2> : Mod\x{e8}le de diagramme (D\x{e9}faut: selon le type de Siteswap)\n\t\t'0' : Ladder;\n\t\t'1' : Applanissement de Ladder (Siteswap Asynchrone);\n\t\t'2' : Ladder avec suppression des Beats impairs en \n\t\tcommen\x{e7}ant \x{e0} 0 (Siteswap Synchrone).\n\n\t\-n <y|n> : Affichage des lancers n\x{e9}gatifs [Exp\x{e9}rimental] \n\t\t(D\x{e9}faut:n).\n\n\t\-o <type> : format d'image (D\x{e9}faut:png) parmi : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-p <int> : P\x{e9}riode minimum \x{e0} afficher (D\x{e9}faut:25).\n\n\t\-s <int> : Affichage du r\x{e9}sultat (D\x{e9}faut:0)\n\t\t'0' : Affiche le r\x{e9}sultat;\n\t\t'1' : Pas d'affichage.\n\n\t\-q <y|n> : Trac\x{e9} Rapide au d\x{e9}pend de la qualit\x{e9} (D\x{e9}faut:n).\n\n\t\-t <y|n> : Affichage du titre de l'image (D\x{e9}faut:y).\n\n\t\-v <\"string\"> : Force la valeur du Titre de l'image.\n\n\t\-y <int> : Style HSS, 0: Dashed, 1: Dotted, 2 : Solid, 3: Bold, 4: Invis (D\x{e9}faut:0).\n\n\t\-z <\"y|n\"> : Z\x{e9}ro possible dans la repr\x{e9}sentation HSS ((D\x{e9}faut:y).";
...
\n\n\tExamples : 24[54] and 24[45] are different"; 	
	...
	our $MSG_CAUSAL_MENU_HELP = "Causal Diagrams.\n"; 
	
	our $MSG_CAUSAL_MENU_CAUSALEDITOR_1 = "Causal Diagram Editor from The Juggling Edge.";
	our $MSG_CAUSAL_MENU_CAUSALEDITOR_2 = "Parameters :\n\n\- None.";
	...
	our $MSG_HSS_MENU_DRAW_2 = "Parameters :\n\n\- <\"oss\"> : OSS to draw.\n\n\- <\"hss\"> : HSS to draw.\n\n\- <\"file\"> : image file for the result.\n\n".$MSG_GRAPHVIZ_OPTS_a4.$MSG_GRAPHVIZ_OPTS_b4."\n\n\n\- [\\%hash] : Optional, transitions hash for OSS. In this case the Siteswap is used for the title only. Each key is Ri:j for a right transition or Li:j for a left one. i is the throw Beat and j is the numero of the thrown object (starting from 0) to help the colorization\n\tEx :  %hash = (
	\t'L2:0' => 'R4:0',
	\t'R2:0' => 'R4:1',
	\t'L4:0' => 'R6:0',
	\t'R4:0' => 'R5:0',
	...
	our $MSG_MHN_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mhn\"> : MHN to draw.\n\n\- <\"file\"> : image file for the result.\n\n".$MSG_GRAPHVIZ_OPTS_a3.$MSG_GRAPHVIZ_OPTS_b3."\n\n\t\-a <y|n> : draw HSS (Default:y)\n\n\t\-b <y|n> : naming core for hands (Default:M)\n\n\n\- [\\%hash] : Optional, transitions hash in Asynchronous model. In this case the Siteswap is used for the title only. Each key is Ri:j for a right transition or Li:j for a left one. i is the throw Beat and j is the numero of the thrown object (starting from 0) to help the colorization\n\tEx :  %hash = (
	\t'L2:0' => 'R4:0',
	\t'R2:0' => 'R4:1',
	\t'L4:0' => 'R6:0',
	\t'R4:0' => 'R5:0',
	...
	our $MSG_MHN_MENU_TOMJN_1 = "Give the corresponding MJN Notation.";
	our $MSG_MHN_MENU_TOMJN_2 = "Parameters :\n\n\- <\"mhn\"> : MHN.\n\- [int] Optional, MJN Model (0: auto, 1: async, 2: sync) (Default:0).\n\- [\-1] Optional, return the result, but do not print it.";
	
	our $MSG_MHN_MENU_GENPOLYRHYTHM_1 = "Polyrhythms Generation.";
	our $MSG_MHN_MENU_GENPOLYRHYTHM_2 = "Parameters :\n\n\- <int> : Number of hands.\n\- <int> : Number of objects.\n\- <int> : Max height in hex.\n\- <\"list\"> : Ratios List from Hand 1 separated by , [ex: 1:2,1:3].\n\- [\\\@List] Optional, Throws to exclude.\n\tEx: \@List=('0','2','1x').\n\t If not set, without other optional parameters, 0 is not used;\n\t if \'\', no exclusion.\n\- [\"options\"] Several options among \-[b|f|j|l|m|q]\n\t\-b <y|n> : print MJN (Default:n).\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (Default:2).\n\t\-j <y|n> : Add modified MHNs with lower throws, keeping the throws tempo thanks to extra Hold Times and usable on JugglingLab. JugglingLab only handles Hold Times for throws 1x or 2, Hold Times are then converted (Default:n).\n\t\-l <y|n> : Add modified MHNs with lower throws, keeping the throws tempo thanks to extra Hold Times (Default:n).\n\t\-m <y|n> : print MJN and MHN (Default:y).\n\t\-q <y|n> : Quick drawing without quality respect (Default:n).\n\n\- [\"file\"] Optional, file to write results in. \nIf the file starts with \n\t\- \'JML:\', issue a JML file with extension .jml \n\tfor JugglingLab view.\n\t\- \'HTML:\', issue an HTML file with extension \n\t\t.html with Ladder Diagrams in it, MJNs version, JML/TXT summary.";

	our $MSG_MHN_MENU_LOWERHEIGHTONTEMPO_1 = "MHNs transformation for lower throws, keeping the Tempo of throws but adding extra Hold Times.";
	our $MSG_MHN_MENU_LOWERHEIGHTONTEMPO_2 = "Interesting to simplify Polyrhythms.\n\nParameters :\n\n\- <\"mhn\"> : MHN to adapt.\n\n\- [\"options\"] Several options \-[f|j|m] described hereafter:\n\t\-f <int> : Number of Minimum Free Beats during transformation between two consecutive throws (Default:1). As the object is catch a small time before being throwed, with a Dwell time around 1 in general a lower value implies Squeezes.\n\t\-j <y|n> : JugglingLab Adaptation. JugglingLab only render Hold Times for throws 1x or 2. It then convert Hold Times with greater values.\n\t\-m <int> : Minimum value for throw on same hand after transformation in order to avoid for example a transformation of throw into hold (Default:3).\n\n[\-1] Optional, return the result, but do not print it (Default:n).";
	
	our $MSG_MHN_MENU_PRINTMHNLISTHTML_1 = "HTML file creation from a MHN list, adding diagrams, JML JugglingLab file and TXT lists.";
	our $MSG_MHN_MENU_PRINTMHNLISTHTML_2 = "Parameters :\n\n\- <\\\@List\"> : Input List with the MHNs or \-1 For empty InputList.\n\n\- <\"outputFile\"> : HTML Files for results (adding extension .html).\n\n\- <\"string\"> : Title.\n\n\- [\"options\"] Several options \-[b|f|j|l|m|q] :\n\n\t\-b <y|n> : Print Both MHN and MJN (Default:n).\n\n\t\-f <0|1|2> : Splines Mode for drawing : 0: spline, 1:curved, 2:line (Default:2).\n\t\-j <y|n> : Add a column with modified MHNs with lower throws, keeping the throws tempo thanks to extra Hold Times and usable on JugglingLab. JugglingLab only handles Hold Times for throws 1x or 2, Hold Times are then converted (Default:n).\n\t\-l <y|n> : Add a column with modified MHNs with lower throws, keeping the throws tempo thanks to extra Hold Times (Default:n).\n\t\-m <y|n> : Print MJN only. Option overwritten by \-b (Default:n).\n\t\-q <y|n> : Quick drawing without quality respect (Default:n).\n\n[\-1] Optional, return the result, but do not print it (Default:n).\n\- <\"inputFile\"> : File with the MHN list if InputList is empty.";
	...
	our $MSG_MHN_POLYRHYTHM_MSG1 = "Ratio(s)";
	our $MSG_MHN_GENPOLYRYTHM_ERR0 = "Number of Ratios must be equal to Hands Number -1.";
	our $MSG_MHN_GENERAL2 = "Object(s) Number";
	our $MSG_MHN_GENERAL3 = "Hand(s) Number";	
	...
	our $MSG_MJN_MENU_HELP = "Multi-Juggler Notation (MJN) as used in JugglingLab or JoePass.\n\nThe used format is the following for each Asynchroneous or Synchroneous Beat :\n<Juggler 1|Juggler 2|...|Juggler j> \nIn Synchroneous, the symbole ! is possible. We will refer to the JugglingLab documentation if needed \n\nHere are some possible example : <2|3p><2p|3><[3p/2]|3p><3|3> ou encore <(2p3,4x)|(2xp3,4p1)|(2xp2,4xp2)>. \nIt is also possible to split per juggler : <22p3p/23|3p33p3>";
	
	our $MSG_MJN_MENU_ISVALID_1 = "Check the MJN validity.";
	our $MSG_MJN_MENU_ISVALID_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to check.\n\- [\-1] Optional, return the result, but do not print it.\n\- [\"List\"] in Asynchroneous, list of initial jugglers hands separated by , if the initial hand is not the right one [ex: R,L,L].";
	our $MSG_MJN_MENU_ISSYNTAXVALID_1 = "Check the MJN grammar syntax.";
	our $MSG_MJN_MENU_ISSYNTAXVALID_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to check.\n\- [\-1] Optional, return the result, but do not print it.";
	our $MSG_MJN_MENU_ISASYNC_1 = "Check if MJN is Asynchronous.";
	our $MSG_MJN_MENU_ISASYNC_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to check.\n\- [\-1] Optional, return the result, but do not print it.";
	our $MSG_MJN_MENU_GETPERIOD_1 = "Give the MJN Period";
	our $MSG_MJN_MENU_GETPERIOD_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to analyze.\n\- [\-1] Optional, return the result, but do not print it.";
	our $MSG_MJN_MENU_GETOBJNUMBER_1 = "Give the number of objects needed for the MJN.";
	our $MSG_MJN_MENU_GETOBJNUMBER_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to analyze.\n\- [\-1] Optional, return the result, but do not print it.";   
	our $MSG_MJN_MENU_GETJUGGLERSNUMBER_1 = "Give the number of jugglers needed for the MJN.";
	our $MSG_MJN_MENU_GETJUGGLERSNUMBER_2 = "Parameters :\n\n\- <\"mjn\"> : MJN to analyze.\n\- [\-1] Optional, return the result, but do not print it."; 
	our $MSG_MJN_MENU_DRAW_1 = "draw the Diagram of a given MJN.";
	our $MSG_MJN_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN to draw.\n\n\- <\"file\"> : image file for the result.\n\n".$MSG_GRAPHVIZ_OPTS_a6.$MSG_GRAPHVIZ_OPTS_b6."\n\n\t\-a <y|n> : draw HSS (Default:y)\n\n\t\-b <y|n> : naming core for hands (Default:M)\n\n\n\- [\\%hash] : Optional, transitions hash in Asynchronous model. In this case the Siteswap is used for the title only. Each key is Ri:j for a right transition or Li:j for a left one. i is the throw Beat and j is the numero of the thrown object (starting from 0) to help the colorization\n\tEx :  %hash = (
	\t'L2:0' => 'R4:0',
	\t'R2:0' => 'R4:1',
	\t'L4:0' => 'R6:0',
	...
	our $MSG_MJN_MENU_TOMHN_1 = "Give the corresponding MHN Notation.";
	our $MSG_MJN_MENU_TOMHN_2 = "Parameters :\n\n\- <\"mjn\"> : MJN.\n\- [\-1] Optional, return the result, but do not print it.\n\- [\"List\"] in Asynchroneous, list of initial jugglers hands separated by , if the initial hand is not the right one [ex: R,L,L].";

	our $MSG_MJN_ISVALID_ERR0 = "Invalid MJN";
	...
	our $MSG_MJHSS_MENU_HELP = "Multi-Juggler Hand Siteswap Notation (MJHSS).\n\nIdea is to apply an HSS on each column of a MJN matrix in a Siteswap Asynchroneous Model. Each row describes thus several hands throwing asynchronously. Format used for MJHSS is : '('HSS1, ... HSSh')', each HSSi applies on column i and is a Vanilla Siteswap.";


	our $MSG_MJHSS_MENU_ISVALID_1 = "Check validity of MJN/MJHSS Combination.";
	our $MSG_MJHSS_MENU_ISVALID_2 = "Parameters :\n\n\- <\"mjn\"> : MJN\n\- <\"mjhss\"> : MJHSS\n\- [\-1] Optional, return the result, but do not print it.";	

	our $MSG_MJHSS_MENU_DRAW_1 = "draw the Diagram of a given MJN/MJHSS.";
	our $MSG_MJHSS_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mjn\"> : MJN to draw.\n\n\- <\"mjhss\"> : corresponding MJHSS.\n\n\- <\"file\"> : image file for the result.\n\n".$MSG_GRAPHVIZ_OPTS_a7.$MSG_GRAPHVIZ_OPTS_b7;
	
	our $MSG_MJHSS_ISVALID_ERR0 = "Error : Invalid MJN."; 
	our $MSG_MJHSS_ISVALID_ERR1 = "Error : there must be the same number of set of hands in the MJN and in the MJHSS.";
	our $MSG_MJHSS_ISVALID_ERR2 = "Error : Invalid HSS"; 
	our $MSG_MJHSS_ISVALID_ERR3 = "Error : HSS must be a Vanilla Siteswap."; 
	our $MSG_MJHSS_ISVALID_ERR4 = "Error : Zero in HSS must correspond to Zero in MJN"; 
	our $MSG_MJHSS_ISVALID_ERR5 = "Error : MJN must use Async Model."; 

	our $MSG_MJHSS_DRAW_1 = "Warning : there should be the same number of set of hands in the MJN and in the MJHSS."; 		 
	...
	our $MSG_MLHSS_MENU_HELP = "Multi-Layer Hand Siteswap Notation (MLHSS).\n\nIdea is to apply an HSS on each row of a MHN matrix. Each row describes thus several hands throwing asynchronously. Format used for MLHSS is : '('HSS1, ... HSSh')', each HSSi applies on row i and is a Vanilla Siteswap.";


	our $MSG_MLHSS_MENU_ISVALID_1 = "Check validity of MHN/MLHSS Combination.";
	our $MSG_MLHSS_MENU_ISVALID_2 = "Parameters :\n\n\- <\"mhn\"> : MHN\n\- <\"mlhss\"> : MLHSS\n\- [\-1] Optional, return the result, but do not print it.";	

	our $MSG_MLHSS_MENU_DRAW_1 = "draw the Diagram of a given MHN/MLHSS.";
	our $MSG_MLHSS_MENU_DRAW_2 = "Param\x{e8}tres :\n\n\- <\"mhn\"> : MHN to draw.\n\n\- <\"mlhss\"> : corresponding MLHSS.\n\n\- <\"file\"> : image file for the result.\n\n".$MSG_GRAPHVIZ_OPTS_a5.$MSG_GRAPHVIZ_OPTS_b5;
	
	our $MSG_MLHSS_ISVALID_ERR0 = "Error : Invalid MHN."; 
	our $MSG_MLHSS_ISVALID_ERR1 = "Error : there must be the same number of set of hands in the MHN and in the MLHSS.";
	our $MSG_MLHSS_ISVALID_ERR2 = "Error : Invalid HSS"; 
	our $MSG_MLHSS_ISVALID_ERR3 = "Error : HSS must be a Vanilla Siteswap."; 
	our $MSG_MLHSS_ISVALID_ERR4 = "Error : Zero in HSS must correspond to Zero in MHN."; 

	our $MSG_MLHSS_DRAW_1 = "Warning : there should be the same number of set of hands in the MHN and in the MLHSS."; 		 
	...
	our $MSG_GRAPHVIZ_OPTS_a3="\- [\"options\"] Several options among \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|z] :";	
	our $MSG_GRAPHVIZ_OPTS_a4="\- [\"options\"] Several options among \-[a|b|c|d|e|g|h|i|l|m|n|o|p|q|s|t|v|y] :";
	our $MSG_GRAPHVIZ_OPTS_a5="\- [\"options\"] Several options among \-[a|b|c|d|e|f|g|h|j|k|l|n|o|p|q|s|t|v|y] :";
	our $MSG_GRAPHVIZ_OPTS_a6="\- [\"options\"] Several options among \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|u|v|w|z] :";	
	our $MSG_GRAPHVIZ_OPTS_a7="\- [\"options\"] Several options among \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|y|z] :";	
	...
	our $MSG_GRAPHVIZ_OPTS_b3="\n\n\t\-a <y|n> : Asynchronous drawing (OSS/HSS) if possible (Default:n)\n\n\t\-b <\"string\"> : naming core for hands (Default:M).\n\n\t\-c <int> : Colorization Model for Asynchronous Drawing (Default:2). Otherwise Colorization is done according to beats and hands order.\n\t\t'0' : No colorization;\n\t\t'1' : Multiplex in increasing order of\n\t\t Siteswap values of previous throws;\n\t\t'2' : Multiplexe in increasing order of \n\t\t Siteswap values of previous throws.\n\n\t\-d <int> :  Synchronous Hack (Default:0)\n\t\t'0' : Remove 0 in the drawing after sync throw since \n\t\tit is catches beats;\n\t\t'1' : No hack.\n\n\t\-e <\"string\"> : Label Edge Color according to the Graphviz X11 \n\tscheme (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E for same as the arrow \n\t(Default:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Keep Graphviz File used for generating (Default:n).\n\n\t\-h <y|n> : Print Hands (Default:y).\n\n\t\-j <y|n> : Print Hand on each Beat, for MLHSS model.\n\n\t\-k \"list of lists using ( ) and ,\" : Print Hands Enumeration for MLHSS Model. Ex (H1,H2)(H3,H4).\n\n\t\-l <pos> : Position of the Siteswap label\n\t\t't': near arrow tail; \n\t\t'h': near arrow head; \n\t\t'm': middle of the arrow; \n\t\t'x': middle of the arrow after drawing; \n\t\t's': around the State; \n\t\t'n': No Siteswap label.\n\n\t\-m <0|1|2> : Diagram Model (Default: According to the Siteswap Type)\n\t\t'0' : Ladder;\n\t\t'1' : Flattened Ladder (Asynchronous Siteswap);\n\t\t'2' : Ladder with odd Beats removed starting from 0\n\t\t\t(Synchronous Siteswap).\n\n\t\-n <y|n> : Draw negatives throws [Experimental] \n\t\t(Default:n).\n\n\t\-p : Periode min to draw (Default:25).\n\n\t\-o <type> : image format (Default:png) through : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-q <y|n> : Quick drawing without quality respect(Default:n).\n\n\t\-s <int> : Print or not the result (Default:0)\n\t\t'0' : print the result;\n\t\t'1' : Silence the result.\n\n\t\-t <y|n> : Draw the image title (Default:y)\n\n\t\-v <\"string\"> : Value to use for the title.\n\n\t\-z <\"y|n\"> : possible Zero in HSS computation ((Default:y).";

	our $MSG_GRAPHVIZ_OPTS_b4="-a <y|n> :  draw HSS (Default:y).\n\n\t\-b <\"string\"> :  naming core for hands (Default:M).\n\n\t\-c <int> :  Colorization Model (Default:2)\n\t\t'0' : No colorization;\n\t\t'1' : Multiplex in increasing order of\n\t\t Siteswap values of previous throws;\n\t\t'2' : Multiplexe in increasing order of \n\t\t Siteswap values of previous throws.\n\n\t\-d <int> :  Synchronous Hack (Default:0)\n\t\t'0' : Remove 0 in the drawing after sync throw since \n\t\tit is catches beats;\n\t\t'1' : No hack.\n\n\t\-e <\"string\"> : Label Edge Color according to the Graphviz X11 \n\tscheme (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E for same as the arrow \n\t(Default:E).\n\n\t\-g <y|n> : Keep Graphviz File used for generating (Default:n).\n\n\t\-h <y|n> : Print Hands.\n\n\t\-i \"list using ,\" : Print Hands Enumeration for Vanilla Flat diagram.\n\n\t\-l <pos> : Position of the Siteswap label\n\t\t't': near arrow tail; \n\t\t'h': near arrow head; \n\t\t'm': middle of the arrow; \n\t\t'x': middle of the arrow after drawing; \n\t\t's': around the State; \n\t\t'n': No Siteswap label.\n\n\t\-m <0|1|2> : Diagram Model (Default: According to the Siteswap Type)\n\t\t'0' : Ladder;\n\t\t'1' : Flattened Ladder (Asynchronous Siteswap);\n\t\t'2' : Ladder with odd Beats removed starting from 0\n\t\t\t(Synchronous Siteswap).\n\n\t\-n <y|n> : Draw negatives throws [Experimental] \n\t\t(Default:n).\n\n\t\-p : Periode min to draw (Default:25).\n\n\t\-o <type> : image format (Default:png) through : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-q <y|n> : Quick drawing without quality respect (Default:n).\n\n\t\-s <int> : Print or not the result (Default:0)\n\t\t'0' : print the result;\n\t\t'1' : Silence the result.\n\n\t\-t <y|n> : Draw the image title (Default:y)\n\n\t\-v <\"string\"> : Value to use for the title.\n\n\t\-y <int> : HSS Style, 0: Dashed, 1: Dotted, 2 : Solid, 3: Bold, 4: Invis (Default:0).";
	
	our $MSG_GRAPHVIZ_OPTS_b5="\n\n\t\-a <y|n> : draw HSS (Default:y)\n\n\t\-b <\"string\"> : naming core for MLHSS Layers (Default:J).\n\n\t\-c <int> : Colorization Model for Asynchronous Drawing (Default:2). Otherwise Colorization is done according to beats and hands order.\n\t\t'0' : No colorization;\n\t\t'1' : Multiplex in increasing order of\n\t\t Siteswap values of previous throws;\n\t\t'2' : Multiplexe in increasing order of \n\t\t Siteswap values of previous throws.\n\n\t\-d <int> :  Synchronous Hack (Default:0)\n\t\t'0' : Remove 0 in the drawing after sync throw since \n\t\tit is catches beats;\n\t\t'1' : No hack.\n\n\t\-e <\"string\"> : Label Edge Color according to the Graphviz X11 \n\tscheme (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E for same as the arrow \n\t(Default:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Keep Graphviz File used for generating (Default:n).\n\n\t\-h <y|n> : Print Layers (Default:y).\n\n\t\-j <y|n> : Print Hand on each Beat (default:y).\n\n\t\-k <\"string\"> : Naming core for Hands (Default:H).\n\n\t\-l <pos> : Position of the Siteswap label\n\t\t't': near arrow tail; \n\t\t'h': near arrow head; \n\t\t'm': middle of the arrow; \n\t\t'x': middle of the arrow after drawing; \n\t\t's': around the State; \n\t\t'n': No Siteswap label.\n\n\t\-n <y|n> : Draw negatives throws [Experimental] \n\t\t(Default:n).\n\n\t\-p : Periode min to draw (Default:25).\n\n\t\-o <type> : image format (Default:png) through : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-q <y|n> : Quick drawing without quality respect(Default:n).\n\n\t\-s <int> : Print or not the result (Default:0)\n\t\t'0' : print the result;\n\t\t'1' : Silence the result.\n\n\t\-t <y|n> : Draw the image title (Default:y)\n\n\t\-v <\"string\"> : Value to use for the title.\n\n\t\-y <int> : HSS Style, 0: Dashed, 1: Dotted, 2 : Solid, 3: Bold, 4: Invis (Default:0).";

	our $MSG_GRAPHVIZ_OPTS_b6="\n\n\t\-a <y|n> : Asynchronous drawing (OSS/HSS) if possible (Default:n)\n\n\t\-b <\"string\"> : naming core for Jugglers (Default:J).\n\n\t\-c <int> : Colorization Model for Asynchronous Drawing (Default:2). Otherwise Colorization is done according to beats and hands order.\n\t\t'0' : No colorization;\n\t\t'1' : Multiplex in increasing order of\n\t\t Siteswap values of previous throws;\n\t\t'2' : Multiplexe in increasing order of \n\t\t Siteswap values of previous throws.\n\n\t\-d <int> :  Synchronous Hack (Default:0)\n\t\t'0' : Remove 0 in the drawing after sync throw since \n\t\tit is catches beats;\n\t\t'1' : No hack.\n\n\t\-e <\"string\"> : Label Edge Color according to the Graphviz X11 \n\tscheme (ex : dodgerblue, red, springgreen, darkviolet, \n\tmagenta, goldenrod, saddlebrown, azure4, khaki4, \n\tdarkorange, olivedrab1, turquoise4, black, peru, \n\tmediumslateblue). E for same as the arrow \n\t(Default:E).\n\n\t\-f <0|1|2> : Splines Mode : 0: spline, 1:curved, 2:line (D\x{e9}faut:2).\n\n\t\-g <y|n> : Keep Graphviz File used for generating (Default:n).\n\n\t\-h <y|n> : Print Jugglers (Default:y).\n\n\t\-j <y|n> : Print Hand on each Beat, for MJHSS model.\n\n\t\-k \"list of lists using ( ) and ,\" : Print Hands Enumeration for MJHSS Model. Ex (H1,H2)(H3,H4).\n\n\t\-l <pos> : Position of the Siteswap label\n\t\t't': near arrow tail; \n\t\t'h': near arrow head; \n\t\t'm': middle of the arrow; \n\t\t'x': middle of the arrow after drawing; \n\t\t's': around the State; \n\t\t'n': No Siteswap label.\n\n\t\-m <0|1|2> : Diagram Model (Default: According to the Siteswap Type)\n\t\t'0' : Ladder;\n\t\t'1' : Flattened Ladder (Asynchronous Siteswap);\n\t\t'2' : Ladder with odd Beats removed starting from 0\n\t\t\t(Synchronous Siteswap).\n\n\t\-n <y|n> : Draw negatives throws [Experimental] \n\t\t(Default:n).\n\n\t\-p : Periode min to draw (Default:25).\n\n\t\-o <type> : image format (Default:png) through : bmp (Windows Bitmap Format), cmapx (client-side imagemap for use in html and xhtml), dia (GTK+ based diagrams), eps (Encapsulated PostScript), fig (XFIG graphics), gd, gd2 (GD/GD2 formats), gif (bitmap graphics), gtk (GTK canvas), hpgl (HP pen plotters) and pcl (Laserjet printers), imap (imagemap files for httpd servers for each node or edge that has a non\-null \"href\" attribute.), jpg, jpeg, jpe (JPEG), mif (FrameMaker graphics), pdf (Portable Document Format), png (Portable Network Graphics format), ps (PostScript), ps2 (PostScript for PDF), svg, svgz (Structured Vector Graphics), tif, tiff (Tag Image File Format), vml, vmlz (Vector Markup Language), vrml (VRML), wbmp (Wireless BitMap format), xlib (Xlib canvas), canon, dot, xdot (Output in DOT langage), plain , plain\-ext (Output in plain text).\n\n\t\-q <y|n> : Quick drawing without quality respect(Default:n).\n\n\t\-s <int> : Print or not the result (Default:0)\n\t\t'0' : print the result;\n\t\t'1' : Silence the result.\n\n\t\-t <y|n> : Draw the image title (Default:y).\n\n\t\-u <\"List\"> in Asynchroneous, list of initial jugglers hands separated by , if the initial hand is not the right one [ex: R,L,L].\n\n\t\-v <\"string\"> : Value to use for the title.\n\n\t\-w <y|n> : Force MHN Model (Default:n).\n\n\t\-z <\"y|n\"> : possible Zero in HSS computation ((Default:y).";
