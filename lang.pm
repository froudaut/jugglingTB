...
{   
	...
	our $MSG_SSWAP_POLYRYTHM_MSG1 = "Ratio";
...
"; 
	...
	our $MSG_SSWAP_MENU_GENPOLYRYTHMOLD_1 = "Polyrythms Gneration (Old Version).";
	our $MSG_SSWAP_MENU_GENPOLYRYTHMOLD_2 = "Parameters :\n\n\- <int> : Number of objects.\n\- <int> : Right Ratio.\n\- <int> : Left Ratio.\n\- [\\\@List] Optional, Throws to exclude.\n\tEx: \@List=('0','e','ex','f','fx').\n\t If not set, without other optional parameters, 0 is not used;\n\t if \'\', no exclusion.\n".$MSG_SSWAP_PRINTSS_OPTS_a1.$MSG_SSWAP_PRINTSS_OPTS_b1."\n\n\- [\"file\"] Optional, file to write results in. \nIf the file starts with \n\t\- \'JML:\', issue a JML file with extension .jml \n\tfor JugglingLab view.\n\t\- \'SSHTML:\', issue an HTML file with extension .html with \n\tsome information on the Siteswaps.";
	our $MSG_SSWAP_MENU_GENPOLYRYTHM_1 = "Polyrythms Generation.";
	our $MSG_SSWAP_MENU_GENPOLYRYTHM_2 = "Parameters :\n\n\- <int> : Number of objects.\n\- <int> : Max height in hex.\n\- <int> : Right Ratio.\n\- <int> : Left Ratio.\n\- [\\\@List] Optional, Throws to exclude.\n\tEx: \@List=('0','2','1x').\n\t If not set, without other optional parameters, 0 is not used;\n\t if \'\', no exclusion.\n".$MSG_SSWAP_PRINTSS_OPTS_a1.$MSG_SSWAP_PRINTSS_OPTS_b1."\n\n\t\-J <y|n> : Double the Tempo for polyrythms 1:M mainly to avoid squeezes (Default:n).\n\n\- [\"file\"] Optional, file to write results in. \nIf the file starts with \n\t\- \'JML:\', issue a JML file with extension .jml \n\tfor JugglingLab view.\n\t\- \'SSHTML:\', issue an HTML file with extension .html with \n\tsome information on the Siteswaps.\n\t\- \'HTML:\', issue an HTML file with extension \n\t\t.html with Ladder Diagrams in it, modified \n\t\tSiteswaps, keeping Tempo mais lowering throw height and related JML Files.";
	our $MSG_SSWAP_MENU_GENPOLYRYTHMMULT_1 = "Polyrythms Generation with Multiplexes.";
	our $MSG_SSWAP_MENU_GENPOLYRYTHMMULT_2 = "Parameters :\n\n\- <int> : Number of objects.\n\- <int> : Max height in hex.\n\- <int> : Number Max of simultaneous throws.\n\- <int> : Right Ratio.\n\- <int> : Left Ratio.\n\- [\\\@List] Optional, Throws to exclude.\n\tEx: \@List=('0','2','1x').\n\t If not set, without other optional parameters, 0 is not used;\n\t if \'\', no exclusion.\n".$MSG_SSWAP_PRINTSS_OPTS_a1.$MSG_SSWAP_PRINTSS_OPTS_b1."\n\n\t\-J <y|n> : Double the Tempo for polyrythms 1:M mainly to avoid squeezes (Default:n).\n\n\- [\"file\"] Optional, file to write results in. \nIf the file starts with \n\t\- \'JML:\', issue a JML file with extension .jml \n\tfor JugglingLab view.\n\t\- \'SSHTML:\', issue an HTML file with extension .html with \n\tsome information on the Siteswaps.\n\t\- \'HTML:\', issue an HTML file with extension \n\t\t.html with Ladder Diagrams in it, modified \n\t\tSiteswaps, keeping Tempo mais lowering throw height and related JML Files.";
