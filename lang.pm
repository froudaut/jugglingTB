...
"; 
	...
	our $MSG_MJHSS_MENU_HELP = "Multi-Juggler Hand Siteswap Notation (MJHSS).\n\nL'id\x{e9}e est d'appliquer un HSS sur chaque colonne d'une matrice MJN en modèle Siteswap Asynchrone.  Le format utilis\x{e9} pour le MJHSS est : '('HSS1, ... HSSh')', chaque HSSi s'appliquant sur la colonne i et \x{e9}tant un Siteswap Vanille.";
	...
	our $MSG_GRAPHVIZ_OPTS_a6 = "\- [\"options\"] Diff\x{e9}rentes options \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|z] pr\x{e9}cis\x{e9}es ci-dessous :";
...
\n\n\tExamples : 24[54] and 24[45] are different"; 	
	...
	our $MSG_GRAPHVIZ_OPTS_a6="\- [\"options\"] Several options among \-[a|b|c|d|e|f|g|h|j|k|l|m|n|o|p|q|s|t|v|z] :";	
